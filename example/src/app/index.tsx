  ...
  useEffect(() => {
    ...
    console.log("------------------")
      ...
      const transactionData = {
        'transaction_id': '12345', 'transaction_currency': 'INR',
        'transaction_payment': '123','transaction_total': 12345.65
      }
      BlotoutSDK.transaction(transactionData, null)

      //---------Item API---------
      const itemData = {
        'item_id': '12345', 'item_name': 'Toy',
        'item_sku': '12','item_currency': 'INR','item_price':'345.54'
      }
